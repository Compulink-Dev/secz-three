    ...
    <footer className="gradient-bg text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <FooterLink href="#" text="Regulations" />
              <FooterLink href="#" text="Publications" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <FooterLink href="#" text="Enforcement" />
              <FooterLink href="#" text="Investor Education" />
              <FooterLink href="#" text="Market Surveillance" />
            </ul>
          </div>
        ...
        <div className="border-t border-amber-800 mt-12 pt-8 text-sm text-amber-400 text-center">
          <p>© 2025 Securities & Exchange Commission. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
...
function FooterLink({ href, text }: any) {
  return (
    <li>
      <a href={href} className="text-amber-200 hover:text-white">
        {text}
      </a>
    </li>
  );
